    ...
    <div className="container-fluid">
      <div className="row justify-content-evenly pt-4">
        <div className="col-md-5">
          <h4 className="pb-3 pt-3" style={{ color: "#424242" }}>
        Charges explained
      </h4>
          ...
          <h6 style={{ color: "#424242" }}>Transaction/Turnover Charges</h6>
          <p className="text-muted" style={{ fontSize: "14px" }}>
        ...
        <div className="col-md-5 mt-5">
          ...
          <p className="text-muted" style={{ fontSize: "14px" }}>
            ...
            than ₹4,00,000. To learn more about BSDA, <a href="d">Click here</a>
          </p>

          <p className="text-muted" style={{ fontSize: "14px" }}>
            For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly
            (90 days). To learn more about AMC, <a href="a">Click here</a>
          </p>
          ...
          <p className="text-muted" style={{ fontSize: "14px" }}>
            ...
            balance in your trading account. <a href="a">Learn more.</a>
          </p>
